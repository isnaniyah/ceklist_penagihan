...
?>
  ...
  <div class="panel-body">
     ...
     <p> <a href="<?=base_url()?>admin_kontrak" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-repeat"></i> Kembali</a>
     </p>
       ...
       <table class="table table-striped">
         ...
         <tr>
          <td>Syarat Pembayaran <a href="<?=base_url()?>admin_syarat/detail_edit/<?php echo base64_encode($ID_KONTRAK) ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a></td>
          <?php
          if (empty($qsyarat)) {
         ...
         <tr>
          <td>Upah Pekerja <a href="<?=base_url()?>admin_upah/awal/<?php echo base64_encode($ID_KONTRAK) ?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-pencil"></i></a></td>
          <?php
          if (empty($qupah)) {
