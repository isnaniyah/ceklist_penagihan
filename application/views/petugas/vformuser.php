...
<div class="panel panel-default">
  ...
  <?php echo $this->session->flashdata('pesan')?>
     <form action="<?=base_url()?>petugas_user/form/<?=$aksi?>" method="post">
       <table class="table table-striped">
        <tr>
          ...
          <td>
            ...
            if($aksi=='aksi_edit'){
              echo $NIP;
              echo '<input type="hidden" name="NIP" class="form-control" value="'.$NIP.'">';
              } else { ?>
            <div class="col-sm-5">
         ...
         <tr>
          <td colspan="2">
            ...
            <a href="<?=base_url()?>petugas_user/user_byid" class="btn btn-default">Batal</button>
          </td>
         </tr>
       </table>
     </form>
