...
<div class="container">
  ...
  <div class="panel-body">
    ...
    <?php
      ...
      ?>
      <a href="<?=base_url()?>petugas_upah/form/add/<?php echo $ID_KONTRAK ?>" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah</a>
       <table class="table table-striped">
        ...
        <?php }else{
         ...
         <tr>
          ...
          <td><?php $angka = $row->JAMINAN_PENSIUN;
            echo "Rp ".number_format($angka, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan).",-";?></td>
          <td>
           <a href="<?=base_url()?>petugas_upah/form/edit/<?php echo $row->ID_UPAH ?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-pencil"></i></a>
           <a href="<?=base_url()?>petugas_upah/hapus/<?php echo $row->ID_UPAH ?>/<?php echo $ID_KONTRAK ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin menghapus data ini?')"><i class="glyphicon glyphicon-trash"></i></a>
          </td>
         </tr>
        <?php } }?>
        </tbody>
        ...
        <a href="<?=base_url()?>petugas_kontrak/detail/<?php echo $ID_KONTRAK ?>" class="btn btn-sm btn-primary">Next</a>
    </div>
        </div>
