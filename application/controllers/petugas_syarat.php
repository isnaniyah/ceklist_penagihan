...
class Petugas_syarat extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('petugas/vsyarat',$data);
	}
    ...
    public function form(){
		...
		if ($mau_ke == "add") {
            ...
            $data['keterangan'] = $ket;
		    $data['aksi'] = 'aksi_add';
            $this->load->view('petugas/vformsyarat',$data);
		} else if ($mau_ke == "edit") {
            ...
            if ($ket == "next") {
                redirect(base_url().'petugas_syarat/detail/'.$ID_KONTRAK2);
            } else {
                redirect(base_url().'petugas_syarat/detail_edit/'.$ID_KONTRAK2);
            }
    ...
    public function hapus($gid, $kontrak, $ket){
        ...
        if ($ket == "next") {
                redirect(base_url().'petugas_syarat/detail/'.$ID_KONTRAK);
            } else {
                redirect(base_url().'petugas_syarat/detail_edit/'.$ID_KONTRAK);
            }
	}
}