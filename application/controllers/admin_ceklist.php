...
class Admin_ceklist extends CI_Controller {
    ...
    public function form(){
		...
		if ($mau_ke == "add") {
            ...
            $this->load->view('admin/vformceklist',$data);
		} else if ($mau_ke == "edit") {
			$data['qceklist']	= $this->mceklist->get_syarat_edit_ceklist($idu);
			$data['title'] = 'Edit data';
		    $data['aksi'] = 'aksi_edit';
            $this->load->view('admin/vformceklist_edit',$data);
            ...
            redirect(base_url().'admin_cekdata/detail/'.$id_data);
          ...
          $data = array(
            ...
            redirect(base_url().'admin_cekdata/detail/'.$ID_DATA_CEKLIST);
        }
    }
    public function hapus($gid){
        ...
        redirect(base_url().'admin_cekdata');
	}
}
