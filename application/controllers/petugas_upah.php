...
class Petugas_upah extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('petugas/vupah',$data);
	}
    ...
    public function form(){
		...
		if ($mau_ke == "add") {
		    ...
		    $data['aksi'] = 'aksi_add';
            $this->load->view('petugas/vformupah',$data);
		} else if ($mau_ke == "edit") {
            ...
            redirect(base_url().'petugas_upah/awal/'.$ID_KONTRAK2);
    ...
    public function hapus($gid, $kontrak){
        ...
        redirect(base_url().'petugas_upah/awal/'.$ID_KONTRAK);
	}
}