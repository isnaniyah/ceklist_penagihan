...
class Petugas_ceklist extends CI_Controller {
    ...
    {
        $data['title'] = 'Daftar Ceklist'; //judul title
    ...
    public function form(){
		...
		if ($mau_ke == "add") {
            ...
            $this->load->view('petugas/vformceklist',$data);
		} else if ($mau_ke == "edit") {
			$data['qceklist']	= $this->mceklist->get_syarat_edit_ceklist($idu);
			$data['title'] = 'Edit Data';
		    $data['aksi'] = 'aksi_edit';
            $this->load->view('petugas/vformceklist_edit',$data);
            ...
            redirect(base_url().'petugas_cekdata/detail/'.$id_data);
          ...
          $data = array(
            ...
            redirect(base_url().'petugas_cekdata/detail/'.$ID_DATA_CEKLIST);
        }
    }
    public function hapus($gid){
        ...
        redirect(base_url().'petugas_cekdata');
	}
}
