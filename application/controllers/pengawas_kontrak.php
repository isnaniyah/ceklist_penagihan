...
class Pengawas_kontrak extends CI_Controller {
    ...
    {
        $data['title'] = 'Data Kontrak'; //judul title
        $data['qkontrak'] = $this->mkontrak->get_allkontrak(); //query model semua Data
        $this->load->view('pengawas/vkontrak',$data);
    ...
    public function form(){
        ...
        if ($mau_ke == "add") {
            ...
            $data['aksi'] = 'aksi_add';
            $this->load->view('pengawas/vformkontrak',$data);
        } else if ($mau_ke == "edit") {
            ...
            redirect(base_url().'pengawas_syarat/detail/'.base64_encode($ID_KONTRAK));
          ...
          $data = array(
            ...
            redirect(base_url().'pengawas_kontrak');
        }
    }
    ...
    public function detail($ID_KONTRAK){
        ...
        $this->load->view('pengawas/vdetkontrak',$data);
        $this->load->view('pengawas/vcekdata',$data2);
